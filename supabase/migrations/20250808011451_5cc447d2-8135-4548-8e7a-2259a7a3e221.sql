-- Patrimônio schema check & creation (idempotent v2)
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Categorias visíveis a todos' AND tablename = 'categorias_patrimonio' AND schemaname = 'public'
  ) THEN
    CREATE POLICY "Categorias visíveis a todos" ON public.categorias_patrimonio FOR SELECT USING (true);
  END IF;
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Gerenciar categorias (admin)' AND tablename = 'categorias_patrimonio' AND schemaname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Subcategorias visíveis a todos' AND tablename = 'subcategorias_patrimonio' AND schemaname = 'public'
  ) THEN
    CREATE POLICY "Subcategorias visíveis a todos" ON public.subcategorias_patrimonio FOR SELECT USING (true);
  END IF;
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Gerenciar subcategorias (admin)' AND tablename = 'subcategorias_patrimonio' AND schemaname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Patrimônios visíveis' AND tablename = 'patrimonios' AND schemaname = 'public'
  ) THEN
    CREATE POLICY "Patrimônios visíveis" ON public.patrimonios FOR SELECT USING (true);
  END IF;
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Gerenciar patrimonios (admin)' AND tablename = 'patrimonios' AND schemaname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Gerenciar manutenções (admin/lider)' AND tablename = 'manutencoes_patrimonio' AND schemaname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Admins e líderes podem gerenciar empréstimos' AND tablename = 'emprestimos_patrimonio' AND schemaname = 'public'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE policyname = 'Sistema pode inserir histórico patrimônio' AND tablename = 'historico_patrimonio' AND schemaname = 'public'
  ) THEN
