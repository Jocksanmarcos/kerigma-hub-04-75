...
CREATE POLICY IF NOT EXISTS "manage louvor presets (leaders/admin)"
...
CREATE POLICY IF NOT EXISTS "read louvor presets (worship readers)"
ON public.louvor_presets_ambiente
AS PERMISSIVE
FOR SELECT
TO authenticated
...
DROP TRIGGER IF EXISTS trg_louvor_presets_ambiente_updated_at ON public.louvor_presets_ambiente;
...
CREATE TABLE IF NOT EXISTS public.culto_setlist_presets (
...
CREATE POLICY IF NOT EXISTS "manage setlist presets (leaders/admin)"
...
CREATE POLICY IF NOT EXISTS "read setlist presets (worship readers)"
ON public.culto_setlist_presets
AS PERMISSIVE
FOR SELECT
TO authenticated
